...
export function HashtagWithSpeechBubble(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg aria-hidden="false" viewBox="0 0 24 24" fill="none" {...props}>
      <path
        fill="currentColor"
        d="M5.433 21a.12.12 0 01-.493-.587L6 17H2.143a.12.12 0 01-.492-.586l.175-1A.5.5 0 012.77 15h3.58l1.06-6H3.553a.12.12 0 01-.492-.586l.175-1A.5.5 0 013.86 7H7.76l.692-3.901A.12.12 0 018.57 3h1.757a.12.12 0 01.493.587L9.76 7h6l.692-3.901A.12.12 0 0116.57 3h1.757a.12.12 0 01.493.587L17.76 7h3.857a.5.5 0 01.492.586l-.175 1A.5.5 0 0120.99 9h-3.58l-1.06 6h3.405a.5.5 0 01.492.586l-.175 1a.5.5 0 01-.492.414H16l-.637 3.587a.5.5 0 01-.492.413h-.984a.5.5 0 01-.493-.587L14 17H8l-.637 3.587a.5.5 0 01-.492.413h-.984zM9.41 9l-1.06 6h6l1.06-6h-6z"
      />
      <path
        fill="currentColor"
